...
//Define la codificacion y la zona horaria predeterminada (Portugal)
...
//Fecha con datetime
                ...
                $fecha = new DateTime(null, new DateTimeZone('Europe/Lisbon'));
                echo 'Hora actual:<br>';
                echo ($fecha->format('h:i:s')) . '<br><br><br>';
                echo 'Fecha actual:<br>';
                echo ($fecha->format('l d  F  Y')) . '<br><br><br>';
//Fecha con formato local por defecto (Portugal)
