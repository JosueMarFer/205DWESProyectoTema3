...
<html lang="en">
    ...
    <body>
        <header>
            <h1>Tema 3</h1>
            <h2>Muestra de codigo del ejercicio 21</h2>
        </header>
        <main>
            <div class="codeLines">
                <?php
...
//ultima actualizacion 13/12/2022
                ...
                show_source("../codigoPHP/ejercicio21.php");
                echo "<br><br><br>";
                echo "<h1>Tratamiento Ejercicio 21</h1>";
                show_source("../codigoPHP/tratamientoEjercicio21.php");
                ?>
            </div>
            <div class="return2">
